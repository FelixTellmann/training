...
* ercent per year and moreover 50 new inhabitants per year come to live in the town. How many years does the town need
...
export const nbYear = (n0, increasePercentage, nAdd, nTarget) => {
  let i = 0;
  while (n0 < nTarget) {
    i++;
    n0 = n0 * (1 + increasePercentage / 100) + nAdd;
  }
  return i;
};